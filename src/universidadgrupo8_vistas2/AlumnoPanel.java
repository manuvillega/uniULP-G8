...
public class AlumnoPanel extends javax.swing.JPanel {
    ...
    private void btn_alumno_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_alumno_guardarActionPerformed
           if (alumnoDuplicadoDandera) {
        JOptionPane.showMessageDialog(this, "Ya se encontró un alumno. Limpie los campos antes de guardar los cambios.", "", JOptionPane.ERROR_MESSAGE);
        return;
    } 
        int dni;
        try {
            ...
            JOptionPane.showMessageDialog(this, "El documento debe ser un número.", "", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void btn_alumno_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_alumno_nuevoActionPerformed
         if (alumnoDuplicadoDandera) {
        JOptionPane.showMessageDialog(this, "Ya se encontró un alumno. Limpie los campos antes de agregar uno nuevo.", "", JOptionPane.ERROR_MESSAGE);
        return;
    } 
        int dni;
        try {
